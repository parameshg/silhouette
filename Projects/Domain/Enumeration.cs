...
// </auto-generated>
// ------------------------------------------------------------------------------
namespace Silhouette.Projects.Domain
{
    using System.Linq;
    using System.Text;
    ...
    #line 1 "C:\Dev\External\silhouette\Projects\Domain\Enumeration.tt"
...
#line hidden
        ...
        {
            this.Write("namespace Backend.Domain.Enumerations;\r\n\r\npublic abstract class Enumeration : ICo" +
                    "mparable\r\n{\r\n    public string Text { get; }\r\n\r\n    public string Value { get; }" +
                    "\r\n\r\n    protected Enumeration(string value)\r\n    {\r\n        Value = value;\r\n    " +
                    "}\r\n\r\n    public static IEnumerable<T> GetValues<T>() where T : Enumeration\r\n    " +
                    "{\r\n        var fields = typeof(T).GetFields(BindingFlags.Public | BindingFlags.S" +
                    "tatic | BindingFlags.DeclaredOnly);\r\n\r\n        return fields.Select(i => i.GetVa" +
                    "lue(null)).Cast<T>();\r\n    }\r\n\r\n    public static bool Parsable<T>(string value)" +
                    " where T : Enumeration\r\n    {\r\n        var result = false;\r\n\r\n        var item =" +
                    " GetValues<T>().FirstOrDefault(i => i.Value.ToUpper() == value.ToUpper());\r\n\r\n  " +
                    "      if (item != null)\r\n        {\r\n            result = true;\r\n        }\r\n\r\n   " +
                    "     return result;\r\n    }\r\n\r\n    public static T Parse<T>(string value) where T" +
                    " : Enumeration\r\n    {\r\n        var result = default(T);\r\n\r\n        if (!string.I" +
                    "sNullOrWhiteSpace(value))\r\n        {\r\n            result = GetValues<T>().FirstO" +
                    "rDefault(i => i.Value.ToUpper() == value.ToUpper());\r\n\r\n            if (result =" +
